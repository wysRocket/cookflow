    ...
    <div className="min-h-screen bg-[#0F172A] text-[#F1F5F9] flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-[#1E293B] border border-[#334155] rounded-2xl p-8 shadow-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="signup-name" className="block text-xs uppercase tracking-widest text-[#94A3B8] mb-2">
              Name
            </label>
            <input
              id="signup-name"
          ...
          <div>
            <label htmlFor="signup-email" className="block text-xs uppercase tracking-widest text-[#94A3B8] mb-2">
              Email
            </label>
            <input
              id="signup-email"
          ...
          <div>
            <label htmlFor="signup-password" className="block text-xs uppercase tracking-widest text-[#94A3B8] mb-2">
              Password
            </label>
            <input
              id="signup-password"
        ...
        <div className="mt-6 flex items-center justify-center space-x-2">
          <span className="h-px bg-[#334155] w-full" />

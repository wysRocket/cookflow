    ...
    <div className="min-h-screen bg-[#0F172A] text-[#F1F5F9] flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-[#1E293B] border border-[#334155] rounded-2xl p-8 shadow-xl">
        ...
        <p className="text-[#94A3B8] text-sm mb-6">
          Access your CookFlow workspace.
        </p>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="signin-email" className="block text-xs uppercase tracking-widest text-[#94A3B8] mb-2">
              Email
            </label>
            <input
              id="signin-email"
          ...
          <div>
            <label htmlFor="signin-password" className="block text-xs uppercase tracking-widest text-[#94A3B8] mb-2">
              Password
            </label>
            <input
              id="signin-password"
        ...
        <p className="text-sm text-[#94A3B8] mt-6 text-center">
          New here?{" "}
          <Link
            to={`/auth/sign-up?next=${encodeURIComponent(next)}`}

...
export const chefs: Chef[] = [
  {
    ...
    banner: "https://images.unsplash.com/photo-1544025162-d76694265947?auto=format&fit=crop&q=80",
    avatar: "https://images.unsplash.com/photo-1583394838336-acd977736f90?auto=format&fit=crop&q=80",
    featuredRecipeId: 1,
  },
  {
    id: 2,
    ...
    banner: "https://images.unsplash.com/photo-1551218808-94e220e084d2?auto=format&fit=crop&q=80",
    avatar: "https://images.unsplash.com/photo-1556157382-97eda2d62296?auto=format&fit=crop&q=80",
    featuredRecipeId: 4,
  },
  {
    id: 3,
  ...
  },
  {
    ...
    banner: "https://images.unsplash.com/photo-1480796927426-f609979314bd?auto=format&fit=crop&w=1200&q=80",
    avatar: "https://images.unsplash.com/photo-1600565193348-f74bd3c7ccdf?auto=format&fit=crop&q=80",
    featuredRecipeId: 4,
  },
  {
    id: 5,
    ...
    banner: "https://images.unsplash.com/photo-1546069901-ec46c77ba130?auto=format&fit=crop&w=1200&q=80",
    avatar: "https://images.unsplash.com/photo-1595273670150-bd0c3c392e46?auto=format&fit=crop&q=80",
    featuredRecipeId: 8,
  },
  {
    id: 6,
...
export const recipes: Recipe[] = [
  {
    ...
    steps: [
      { text: "Preheat oven to 400°F (200°C) and line a baking sheet with foil.", duration: "5 min" },
      ...
      { text: "Sear salmon skin-side up for 2-3 minutes until golden brown on the surface.", duration: "3 min" },
      { text: "Flip salmon and brush generously with the honey glaze, coating all surfaces." },
      { text: "Transfer to oven and bake for 8-10 minutes until cooked through and glaze is caramelised.", duration: "10 min" },
  ...
  },
  {
    ...
    description: "A vibrant, antioxidant-rich smoothie bowl topped with fresh berries, coconut flakes, and crunchy granola to kickstart your morning.",
    ingredients: [
    ...
    steps: [
      { text: "Run acai packets under warm water for 5 seconds to slightly thaw before opening.", duration: "1 min" },
      ...
      { text: "Pour the thick smoothie base into a chilled bowl.", duration: "1 min" },
  ...
  },
  {
    ...
    steps: [
      { text: "Toast the sourdough bread until deep golden and crispy throughout.", duration: "3 min" },
      ...
      { text: "If adding eggs, fry in a little butter or poach for 3 minutes in simmering water.", duration: "3 min" },
  ...
  },
  {
    ...
    steps: [
      { text: "Bring chicken broth to a gentle simmer in a large pot over medium heat.", duration: "5 min" },
      { text: "Whisk in miso paste and chili oil until fully dissolved and broth is fragrant." },
      { text: "Cook ramen noodles in a separate pot according to package instructions.", duration: "3 min" },
      { text: "Prepare soft-boiled eggs: boil for exactly 6 minutes, then transfer to an ice bath.", duration: "6 min" },
  ...
  },
  {
    ...
    badge: "Quick",
    badgeColor: "bg-[#D4AF37]",
    description: "A crisp, refreshing Mediterranean classic featuring ripe tomatoes, crisp cucumbers, sharp red onion, Kalamata olives, and a block of creamy feta cheese dressed in oregano-infused olive oil.",
    ingredients: [
    ...
    steps: [
      ...
      { text: "Place the intact block of feta cheese right on top of the salad.", duration: "1 min" },
  ...
  },
  {
    ...
    badge: "Popular",
    badgeColor: "bg-[#14b8a6]",
    description: "A decadent, restaurant-quality dessert with a perfectly baked cake exterior holding a molten, flowing chocolate ganache center.",
    ingredients: [
    ...
    steps: [
      { text: "Preheat oven to 200°C (400°F). Generously butter two ramekins and dust the insides with cocoa powder.", duration: "5 min" },
      ...
      { text: "Bake for exactly 10-12 minutes. The edges should be set, but the center must be soft.", duration: "12 min" },
  ...
  },
  {
    ...
    description: "The perfect make-ahead breakfast. Creamy oats steeped in milk, naturally sweetened with maple syrup, and ready to grab-and-go in the morning.",
    ingredients: [
    ...
    steps: [
      ...
      { text: "Stir thoroughly until completely combined and there are no dry pockets of oats.", duration: "1 min" },
      { text: "Seal the container and place it in the refrigerator overnight (or for at least 4 hours).", duration: "4 hours" },
  ...
  },
  {
    ...
    description: "Zesty, deeply spiced grilled chicken folded tightly into warm corn tortillas with a vibrant fresh pico de gallo and a squeeze of lime.",
    ingredients: [
    ...
    steps: [
      ...
      { text: "Heat a heavy skillet or grill pan over medium-high heat until very hot.", duration: "2 min" },
      { text: "Cook the chicken for 4-5 minutes per side until charred and cooked through.", duration: "10 min" },
      { text: "Remove chicken from heat, let rest for 3 minutes, then chop into bite-sized pieces." },
      { text: "Warm the corn tortillas slightly in a dry pan or microwave so they don't break.", duration: "2 min" },
  ...
  },
  {
    ...
    description: "A labor of love resulting in a luxuriously creamy, velvety rice dish packed with the earthy, deep umami flavor of roasted wild mushrooms and parmesan.",
    ingredients: [
    ...
    steps: [
      ...
      { text: "In a wide, heavy-bottomed pan, sauté the mushrooms in a little butter until deeply browned. Remove and set aside.", duration: "8 min" },
      { text: "In the same pan, sauté the shallot in remaining butter until translucent, then add garlic.", duration: "3 min" },
      { text: "Add the rice and toast it, stirring constantly, until the edges turn slightly translucent.", duration: "2 min" },
      { text: "Pour in the white wine and stir until completely absorbed by the rice." },
      { text: "Begin adding the hot stock one ladleful at a time, stirring constantly and allowing each addition to be absorbed before adding the next.", duration: "20 min" },
      { text: "When rice is al dente and creamy, remove from heat. Stir in the cooked mushrooms, parmesan, and a knob of cold butter." },
      { text: "Cover and let rest for 2 minutes before serving garnished with fresh thyme.", duration: "2 min" }
    ]
  },
  {
    id: 10,
    ...
    description: "Fluffy, tender, edge-crispy pancakes with a gorgeous natural sweetness from overripe bananas. Perfect for a cozy weekend morning.",
    ingredients: [
    ...
    steps: [
      { text: "In a large bowl, mash the overripe banana until very smooth.", duration: "1 min" },
      ...
      { text: "Pour the wet ingredients into the dry ingredients. Fold gently until just combined. Lumps are okay!", duration: "2 min" },
      { text: "Heat a non-stick skillet or griddle over medium heat and lightly coat with butter." },
      { text: "Pour ¼ cup of batter for each pancake. Cook until bubbles form on the surface and edges look dry.", duration: "3 min" },
      { text: "Flip and cook until the underside is golden brown. Repeat with remaining batter.", duration: "2 min" },
  ...
  },
  {
    ...
    description: "Thailand's famous hot and sour soup. A complex, aromatic broth layered with lemongrass, galangal, lime leaves, and explosive chili heat, swimming with plump shrimp.",
    ingredients: [
    ...
    steps: [
      ...
      { text: "Add lemongrass, galangal, kaffir lime leaves, and chilies. Simmer vigorously to release the aromatics.", duration: "10 min" },
      { text: "Add the mushrooms and simmer for another 3 minutes until softened." },
      { text: "Add the shrimp and cook until just pink and opaque. Do not overcook.", duration: "3 min" },
      ...
      { text: "Ladle into bowls, discarding the woody aromatics if preferred.", duration: "2 min" },
  ...
  },
  {
    ...
    badge: "Popular",
    badgeColor: "bg-[#14b8a6]",
    description: "The classic 'pick-me-up'. Layers of espresso-soaked ladyfingers enveloped in a cloud-like mascarpone zabaglione, heavily dusted with bitter cocoa.",
    ingredients: [
      "4 large egg yolks",
    ...
    steps: [
      { text: "In a heatproof bowl set over simmering water, whisk yolks and sugar constantly until pale and thick (sabayon).", duration: "8 min" },
      { text: "Remove from heat and gently whisk in the mascarpone until completely smooth." },
      { text: "In a separate bowl, whip the heavy cream to stiff peaks. Gently fold it into the mascarpone mixture.", duration: "5 min" },
      { text: "Combine the cooled espresso and coffee liqueur in a shallow bowl." },
      { text: "One by one, quickly dip the ladyfingers into the espresso (about 1 second per side) and arrange in a single layer in a 9x9 inch dish.", duration: "4 min" },
      ...
      { text: "Refrigerate for at least 6 hours, preferably overnight. Dust heavily with cocoa powder just before serving.", duration: "6 hours" }
    ]
  }
];
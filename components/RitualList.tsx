...
const RitualList: React.FC = () => {
  return (
    <section
      id="rituals"
      className="py-24 bg-obsidian-light relative overflow-hidden"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-4">
            ...
            <p className="text-gray-400 mb-8 leading-relaxed">
              These are not just recipes. They are rituals. Multi-day processes
              designed to fundamentally alter your relationship with
              ingredients.
            </p>
            <Link
              to="/app/recipes"
              className="text-saffron flex items-center gap-2 hover:gap-4 transition-all duration-300 uppercase tracking-widest text-xs font-bold"
            >
              ...
              >
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                  <div>
                    <div className="flex gap-2 mb-3">
                      {ritual.tags.map((tag) => (
                        <span
                          key={tag}
                          className="text-[10px] uppercase tracking-widest px-2 py-1 rounded bg-black/40 text-gray-400 border border-white/5"
                        >
                          {tag}
                        </span>
                      ))}
                  ...
                  <div className="flex items-center gap-6 shrink-0 border-t md:border-t-0 md:border-l border-white/10 pt-4 md:pt-0 md:pl-6">
                    ...
                    <Link
                      to="/app/recipes"
                      className="p-3 rounded-full bg-white/5 text-white hover:bg-[#14b8a6] hover:text-obsidian transition-colors duration-300"
                    >
